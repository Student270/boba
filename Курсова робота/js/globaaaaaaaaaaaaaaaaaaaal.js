...
// var changelangugeng = document.getElementById("Langugua");
...
// var changetemalghtua = document.getElementById("lightua");
// var changetemalghteng = document.getElementById("lighteng");
// var changetemadarcua = document.getElementById("darcua");
// var changetemadarceng = document.getElementById("darceng");


// changetemalghtua.addEventListener("click", function(){

//     changetemalghtua.classList.toogel("hide");
//     changetemadarkua.classList.toggle("hide");
//     changetemalghteng.classList.toogel("hide");
//     changetemadarkeng.classList.toogel("hide");

// });

// changetemadarcua.addEventListener("click", function(){

//     changetemalghtua.toogel("hide");
//     changetemalghteng.toogel("hide");
//     changetemadarcua.toogel("hide");
//     changetemadarceng.toogel("hide");
